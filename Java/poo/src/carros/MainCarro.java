...
public class MainCarro {
    ...
    System.out.println("Abastencendo 20 litros no punto");
    punto.abastecer(20);
    System.out.println("Abastencendo 50 litros no punto");
    int sobraPunto = punto.abastecer(50); 

    System.out.println("Abastencendo 30 litros no civic");
    civic.abastecer(30);
    System.out.println("Abastencendo 100 litros no civic");
